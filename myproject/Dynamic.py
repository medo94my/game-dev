...
class Dynamic():
    ...
    def randomize(self,num_of_six,color_of_six,letter_of_26):
        ...
        self.letter=['Q','W','E','R','T','Y','U','I','O','P','A','S','D','F','G','H','J','K','L','Z','X','C','V','B','N','M']
        ...
        self.Answer = S(S(range(1, 9), num_of_six)+S(self.color, color_of_six)+S(self.letter,letter_of_26),self.smap)
        print(self.Answer)
    ...
    def check(self, guess_director):  # ==========================================
        ...
        number = ['1', '2', '3', '4', '5', '6', '7', '8','9','Q','W','E','R','T','Y','U','I','O','P','A','S','D','F','G','H','J','K','L','Z','X','C','V','B','N','M','GREEN', 'BLUE', 'RED', 'YELLOW', 'PURPLE', 'BROWN']
        ...
        def guess_num():
            ...
            if  Valid_counter == len(self.Answer) and len(guess) == len(self.Answer):
                return guess
        ...
        if checker != -1:
            ...
            for x in range(len(self.Answer)):
                for y in range(len(self.Answer)):  # This checks every guess with the final answer
            ...
            if self.cright == len(self.Answer):
                ...
                self.Answer = S(S(range(1, 9), self.num_of_six)+S(self.color, self.color_of_six)+S(self.letter,self.letter_of_26),self.smap)
